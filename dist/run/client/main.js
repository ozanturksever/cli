...
function () {
  function Client(_ref) {
    ...
    var _ref2 = search.match(/l=(\d{4})/) || [],
        _ref3 = _slicedToArray(_ref2, 2),
        _ref3$ = _ref3[1],
        id = _ref3$ === void 0 ? '' : _ref3$;

    this.listeners = {};
    this.socket = new WebSocket("ws://".concat(hostname, ":").concat(port, "/client/").concat(id));
...
window.client.on('proxy:connected', function (url) {
